        ...
        <section id="hero"
            ...
            <div className="container grid grid-cols-1 md:grid-cols-8 gap-10 items-center">
                <div className="col-span-3 w-full h-full ">
                    <img src={avatar} alt="" className="rounded-3xl w-full max-w-[400px] object-cover" />
                </div>
                <div className="col-span-5 space-y-7">
                    ...
                    <div className="flex flex-row justify-center space-x-5 relative mt-5">
                       <a href="#about">
                         <ButtonCustom onClick={() => document.getElementById('about').scrollIntoView({behavior:'smooth'})} >
                            <div className="w-1/3 h-full flex items-center justify-center">
                                <div className="w-13 h-12 bg-[var(--main)] rounded-full flex items-center justify-center
                        ...
                        <a href="#projetcts">
                            <ButtonCustom>
                            <div className="w-1/3 h-full flex items-center justify-center ">
                                <div className="w-13 h-12 rounded-full bg-[var(--main)] flex items-center justify-center
                                               group-hover:animate-slide-icon-right">
